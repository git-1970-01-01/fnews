...
<body>
  ...
  <ignore_js_op> 
   ...
   <div class="tip tip_4 aimg_tip" id="aimg_1326665_menu" style="position: absolute; display: none" disautofocus="true"> 
    <div class="xs0"> 
     ...
     <p> <a href="forum.php?mod=attachment&amp;aid=MTMyNjY2NXxmODRjODdkMHwxNTc4ODUzNjI5fDB8NTUwNDU1&amp;nothumb=yes" target="_blank">下载附件</a> &nbsp;<a href="javascript:;" onclick="showWindow(this.id, this.getAttribute('url'), 'get', 0);" id="savephoto_1326665" url="home.php?mod=spacecp&amp;ac=album&amp;op=saveforumphoto&amp;aid=1326665&amp;handlekey=savephoto_1326665">保存到相册</a> </p> 
 ...
 <br> 
 <div align="center"> 
  <span id="flv_Afk"></span> 
  <script type="text/javascript" reload="1">$('flv_Afk').innerHTML=(mobileplayer() ? "<iframe height='500' width='800' src='https://www.youtube.com/embed/XsvFlQd1hwg' frameborder=0 allowfullscreen></iframe>" : AC_FL_RunContent('width', '800', 'height', '500', 'allowNetworking', 'internal', 'allowScriptAccess', 'never', 'src', 'https://www.youtube.com/v/XsvFlQd1hwg&hl=zh_CN&fs=1', 'quality', 'high', 'bgcolor', '#ffffff', 'wmode', 'transparent', 'allowfullscreen', 'true'));</script> 
 </div>
 <br> 
 <div align="center"> 
  <span id="flv_wr1"></span> 
  <script type="text/javascript" reload="1">$('flv_wr1').innerHTML=(mobileplayer() ? "<iframe height='500' width='800' src='https://www.youtube.com/embed/pObHtYp5VnY' frameborder=0 allowfullscreen></iframe>" : AC_FL_RunContent('width', '800', 'height', '500', 'allowNetworking', 'internal', 'allowScriptAccess', 'never', 'src', 'https://www.youtube.com/v/pObHtYp5VnY&hl=zh_CN&fs=1', 'quality', 'high', 'bgcolor', '#ffffff', 'wmode', 'transparent', 'allowfullscreen', 'true'));</script> 
 </div>
 <br> 
 <div align="center"> 
  <span id="flv_ID4"></span> 
  <script type="text/javascript" reload="1">$('flv_ID4').innerHTML=(mobileplayer() ? "<iframe height='500' width='800' src='https://www.youtube.com/embed/xzxx6ps7flo' frameborder=0 allowfullscreen></iframe>" : AC_FL_RunContent('width', '800', 'height', '500', 'allowNetworking', 'internal', 'allowScriptAccess', 'never', 'src', 'https://www.youtube.com/v/xzxx6ps7flo&hl=zh_CN&fs=1', 'quality', 'high', 'bgcolor', '#ffffff', 'wmode', 'transparent', 'allowfullscreen', 'true'));</script> 
 </div>
 <br> 
 <div align="left"> 
 ...
 <div align="center"> 
  <span id="flv_kZt"></span> 
  <script type="text/javascript" reload="1">$('flv_kZt').innerHTML=(mobileplayer() ? "<iframe height='500' width='800' src='https://www.youtube.com/embed/0h9bZFQoMuk' frameborder=0 allowfullscreen></iframe>" : AC_FL_RunContent('width', '800', 'height', '500', 'allowNetworking', 'internal', 'allowScriptAccess', 'never', 'src', 'https://www.youtube.com/v/0h9bZFQoMuk&hl=zh_CN&fs=1', 'quality', 'high', 'bgcolor', '#ffffff', 'wmode', 'transparent', 'allowfullscreen', 'true'));</script> 
 </div>
 <br> 
 <div align="center"> 
  <span id="flv_LhT"></span> 
  <script type="text/javascript" reload="1">$('flv_LhT').innerHTML=(mobileplayer() ? "<iframe height='500' width='800' src='https://www.youtube.com/embed/FIOoyYKbe6Q' frameborder=0 allowfullscreen></iframe>" : AC_FL_RunContent('width', '800', 'height', '500', 'allowNetworking', 'internal', 'allowScriptAccess', 'never', 'src', 'https://www.youtube.com/v/FIOoyYKbe6Q&hl=zh_CN&fs=1', 'quality', 'high', 'bgcolor', '#ffffff', 'wmode', 'transparent', 'allowfullscreen', 'true'));</script> 
 </div>
 <br> 
 <div align="center"> 
  <span id="flv_wvL"></span> 
  <script type="text/javascript" reload="1">$('flv_wvL').innerHTML=(mobileplayer() ? "<iframe height='500' width='800' src='https://www.youtube.com/embed/yy0CEV-cIU4' frameborder=0 allowfullscreen></iframe>" : AC_FL_RunContent('width', '800', 'height', '500', 'allowNetworking', 'internal', 'allowScriptAccess', 'never', 'src', 'https://www.youtube.com/v/yy0CEV-cIU4&hl=zh_CN&fs=1', 'quality', 'high', 'bgcolor', '#ffffff', 'wmode', 'transparent', 'allowfullscreen', 'true'));</script> 
 </div>
 <br>
</body>
