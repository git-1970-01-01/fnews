...
layout: post
author: "「鲍比希尔」 on 2020-1-13 13:29"
header-style: text
tags:
  - 新闻
  - 雁塔
...
<body>
   ...
   <ignore_js_op> 
    ...
    <div class="tip tip_4 aimg_tip" id="aimg_1326666_menu" style="position: absolute; display: none" disautofocus="true"> 
     <div class="xs0"> 
      ...
      <p> <a href="forum.php?mod=attachment&amp;aid=MTMyNjY2NnwxOTM2ODJlN3wxNTc4ODkzNTAxfDB8NTUwNDU1&amp;nothumb=yes" target="_blank">下载附件</a> &nbsp;<a href="javascript:;" onclick="showWindow(this.id, this.getAttribute('url'), 'get', 0);" id="savephoto_1326666" url="home.php?mod=spacecp&amp;ac=album&amp;op=saveforumphoto&amp;aid=1326666&amp;handlekey=savephoto_1326666">保存到相册</a> </p> 
      <p class="xg1 y"><span title="2020-1-12 18:18">昨天&nbsp;18:18</span> 上传</p> 
     </div> 
     <div class="tip_horn"></div> 
    </div> 
  ...
  <ignore_js_op> 
   ...
   <div class="tip tip_4 aimg_tip" id="aimg_1326667_menu" style="position: absolute; display: none" disautofocus="true"> 
    <div class="xs0"> 
     ...
     <p> <a href="forum.php?mod=attachment&amp;aid=MTMyNjY2N3xjOWFlNmEwMHwxNTc4ODkzNTAxfDB8NTUwNDU1&amp;nothumb=yes" target="_blank">下载附件</a> &nbsp;<a href="javascript:;" onclick="showWindow(this.id, this.getAttribute('url'), 'get', 0);" id="savephoto_1326667" url="home.php?mod=spacecp&amp;ac=album&amp;op=saveforumphoto&amp;aid=1326667&amp;handlekey=savephoto_1326667">保存到相册</a> </p> 
     <p class="xg1 y"><span title="2020-1-12 18:18">昨天&nbsp;18:18</span> 上传</p> 
    </div> 
    <div class="tip_horn"></div> 
   </div> 
 ...
 <br> 
 <div align="center"> 
  <span id="flv_O95"></span> 
  <script type="text/javascript" reload="1">$('flv_O95').innerHTML=(mobileplayer() ? "<iframe height='500' width='800' src='https://www.youtube.com/embed/XsvFlQd1hwg' frameborder=0 allowfullscreen></iframe>" : AC_FL_RunContent('width', '800', 'height', '500', 'allowNetworking', 'internal', 'allowScriptAccess', 'never', 'src', 'https://www.youtube.com/v/XsvFlQd1hwg&hl=zh_CN&fs=1', 'quality', 'high', 'bgcolor', '#ffffff', 'wmode', 'transparent', 'allowfullscreen', 'true'));</script> 
 </div>
 <br> 
 <div align="center"> 
  <span id="flv_pga"></span> 
  <script type="text/javascript" reload="1">$('flv_pga').innerHTML=(mobileplayer() ? "<iframe height='500' width='800' src='https://www.youtube.com/embed/pObHtYp5VnY' frameborder=0 allowfullscreen></iframe>" : AC_FL_RunContent('width', '800', 'height', '500', 'allowNetworking', 'internal', 'allowScriptAccess', 'never', 'src', 'https://www.youtube.com/v/pObHtYp5VnY&hl=zh_CN&fs=1', 'quality', 'high', 'bgcolor', '#ffffff', 'wmode', 'transparent', 'allowfullscreen', 'true'));</script> 
 </div>
 <br> 
 <div align="center"> 
  <span id="flv_Vg4"></span> 
  <script type="text/javascript" reload="1">$('flv_Vg4').innerHTML=(mobileplayer() ? "<iframe height='500' width='800' src='https://www.youtube.com/embed/xzxx6ps7flo' frameborder=0 allowfullscreen></iframe>" : AC_FL_RunContent('width', '800', 'height', '500', 'allowNetworking', 'internal', 'allowScriptAccess', 'never', 'src', 'https://www.youtube.com/v/xzxx6ps7flo&hl=zh_CN&fs=1', 'quality', 'high', 'bgcolor', '#ffffff', 'wmode', 'transparent', 'allowfullscreen', 'true'));</script> 
 </div>
 <br> 
 <div align="left"> 
 ...
 <div align="center"> 
  <span id="flv_hr4"></span> 
  <script type="text/javascript" reload="1">$('flv_hr4').innerHTML=(mobileplayer() ? "<iframe height='500' width='800' src='https://www.youtube.com/embed/0h9bZFQoMuk' frameborder=0 allowfullscreen></iframe>" : AC_FL_RunContent('width', '800', 'height', '500', 'allowNetworking', 'internal', 'allowScriptAccess', 'never', 'src', 'https://www.youtube.com/v/0h9bZFQoMuk&hl=zh_CN&fs=1', 'quality', 'high', 'bgcolor', '#ffffff', 'wmode', 'transparent', 'allowfullscreen', 'true'));</script> 
 </div>
 <br> 
 <div align="center"> 
  <span id="flv_sJ7"></span> 
  <script type="text/javascript" reload="1">$('flv_sJ7').innerHTML=(mobileplayer() ? "<iframe height='500' width='800' src='https://www.youtube.com/embed/FIOoyYKbe6Q' frameborder=0 allowfullscreen></iframe>" : AC_FL_RunContent('width', '800', 'height', '500', 'allowNetworking', 'internal', 'allowScriptAccess', 'never', 'src', 'https://www.youtube.com/v/FIOoyYKbe6Q&hl=zh_CN&fs=1', 'quality', 'high', 'bgcolor', '#ffffff', 'wmode', 'transparent', 'allowfullscreen', 'true'));</script> 
 </div>
 <br> 
 <div align="center"> 
  <span id="flv_wMX"></span> 
  <script type="text/javascript" reload="1">$('flv_wMX').innerHTML=(mobileplayer() ? "<iframe height='500' width='800' src='https://www.youtube.com/embed/yy0CEV-cIU4' frameborder=0 allowfullscreen></iframe>" : AC_FL_RunContent('width', '800', 'height', '500', 'allowNetworking', 'internal', 'allowScriptAccess', 'never', 'src', 'https://www.youtube.com/v/yy0CEV-cIU4&hl=zh_CN&fs=1', 'quality', 'high', 'bgcolor', '#ffffff', 'wmode', 'transparent', 'allowfullscreen', 'true'));</script> 
 </div>
 <br>
</body>
