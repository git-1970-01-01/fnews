...
<body>
   ...
   <ignore_js_op> 
    ...
    <div class="tip tip_4 aimg_tip" id="aimg_1326666_menu" style="position: absolute; display: none" disautofocus="true"> 
     <div class="xs0"> 
      ...
      <p> <a href="forum.php?mod=attachment&amp;aid=MTMyNjY2NnxjNWI1OTM2OHwxNTc4ODM5NjkxfDB8NTUwNDU1&amp;nothumb=yes" target="_blank">下载附件</a> &nbsp;<a href="javascript:;" onclick="showWindow(this.id, this.getAttribute('url'), 'get', 0);" id="savephoto_1326666" url="home.php?mod=spacecp&amp;ac=album&amp;op=saveforumphoto&amp;aid=1326666&amp;handlekey=savephoto_1326666">保存到相册</a> </p> 
      <p class="xg1 y"><span title="2020-1-12 18:18">4&nbsp;小时前</span> 上传</p> 
     </div> 
     <div class="tip_horn"></div> 
    </div> 
  ...
  <ignore_js_op> 
   ...
   <div class="tip tip_4 aimg_tip" id="aimg_1326668_menu" style="position: absolute; display: none" disautofocus="true"> 
    <div class="xs0"> 
     ...
     <p> <a href="forum.php?mod=attachment&amp;aid=MTMyNjY2OHxhZTY2NDVmYXwxNTc4ODM5NjkxfDB8NTUwNDU1&amp;nothumb=yes" target="_blank">下载附件</a> &nbsp;<a href="javascript:;" onclick="showWindow(this.id, this.getAttribute('url'), 'get', 0);" id="savephoto_1326668" url="home.php?mod=spacecp&amp;ac=album&amp;op=saveforumphoto&amp;aid=1326668&amp;handlekey=savephoto_1326668">保存到相册</a> </p> 
     <p class="xg1 y"><span title="2020-1-12 18:18">4&nbsp;小时前</span> 上传</p> 
    </div> 
    <div class="tip_horn"></div> 
   </div> 
 ...
 <br> 
 <div align="center"> 
  <span id="flv_tz4"></span> 
  <script type="text/javascript" reload="1">$('flv_tz4').innerHTML=(mobileplayer() ? "<iframe height='500' width='800' src='https://www.youtube.com/embed/XsvFlQd1hwg' frameborder=0 allowfullscreen></iframe>" : AC_FL_RunContent('width', '800', 'height', '500', 'allowNetworking', 'internal', 'allowScriptAccess', 'never', 'src', 'https://www.youtube.com/v/XsvFlQd1hwg&hl=zh_CN&fs=1', 'quality', 'high', 'bgcolor', '#ffffff', 'wmode', 'transparent', 'allowfullscreen', 'true'));</script> 
 </div>
 <br> 
 <div align="center"> 
  <span id="flv_k0D"></span> 
  <script type="text/javascript" reload="1">$('flv_k0D').innerHTML=(mobileplayer() ? "<iframe height='500' width='800' src='https://www.youtube.com/embed/pObHtYp5VnY' frameborder=0 allowfullscreen></iframe>" : AC_FL_RunContent('width', '800', 'height', '500', 'allowNetworking', 'internal', 'allowScriptAccess', 'never', 'src', 'https://www.youtube.com/v/pObHtYp5VnY&hl=zh_CN&fs=1', 'quality', 'high', 'bgcolor', '#ffffff', 'wmode', 'transparent', 'allowfullscreen', 'true'));</script> 
 </div>
 <br> 
 <div align="center"> 
  <span id="flv_F13"></span> 
  <script type="text/javascript" reload="1">$('flv_F13').innerHTML=(mobileplayer() ? "<iframe height='500' width='800' src='https://www.youtube.com/embed/xzxx6ps7flo' frameborder=0 allowfullscreen></iframe>" : AC_FL_RunContent('width', '800', 'height', '500', 'allowNetworking', 'internal', 'allowScriptAccess', 'never', 'src', 'https://www.youtube.com/v/xzxx6ps7flo&hl=zh_CN&fs=1', 'quality', 'high', 'bgcolor', '#ffffff', 'wmode', 'transparent', 'allowfullscreen', 'true'));</script> 
 </div>
 <br> 
 <div align="left"> 
 ...
 <div align="center"> 
  <span id="flv_k68"></span> 
  <script type="text/javascript" reload="1">$('flv_k68').innerHTML=(mobileplayer() ? "<iframe height='500' width='800' src='https://www.youtube.com/embed/0h9bZFQoMuk' frameborder=0 allowfullscreen></iframe>" : AC_FL_RunContent('width', '800', 'height', '500', 'allowNetworking', 'internal', 'allowScriptAccess', 'never', 'src', 'https://www.youtube.com/v/0h9bZFQoMuk&hl=zh_CN&fs=1', 'quality', 'high', 'bgcolor', '#ffffff', 'wmode', 'transparent', 'allowfullscreen', 'true'));</script> 
 </div>
 <br> 
 <div align="center"> 
  <span id="flv_ATF"></span> 
  <script type="text/javascript" reload="1">$('flv_ATF').innerHTML=(mobileplayer() ? "<iframe height='500' width='800' src='https://www.youtube.com/embed/FIOoyYKbe6Q' frameborder=0 allowfullscreen></iframe>" : AC_FL_RunContent('width', '800', 'height', '500', 'allowNetworking', 'internal', 'allowScriptAccess', 'never', 'src', 'https://www.youtube.com/v/FIOoyYKbe6Q&hl=zh_CN&fs=1', 'quality', 'high', 'bgcolor', '#ffffff', 'wmode', 'transparent', 'allowfullscreen', 'true'));</script> 
 </div>
 <br> 
 <div align="center"> 
  <span id="flv_pXJ"></span> 
  <script type="text/javascript" reload="1">$('flv_pXJ').innerHTML=(mobileplayer() ? "<iframe height='500' width='800' src='https://www.youtube.com/embed/yy0CEV-cIU4' frameborder=0 allowfullscreen></iframe>" : AC_FL_RunContent('width', '800', 'height', '500', 'allowNetworking', 'internal', 'allowScriptAccess', 'never', 'src', 'https://www.youtube.com/v/yy0CEV-cIU4&hl=zh_CN&fs=1', 'quality', 'high', 'bgcolor', '#ffffff', 'wmode', 'transparent', 'allowfullscreen', 'true'));</script> 
 </div>
 <br>
</body>
